...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>trouser 1</b></h4></center>
    ...
    <td> 
        ...
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>trouser 2</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
        </a>        
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>trouser 3</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>trouser  4</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>trouser 5</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center><h4><b>trouser 6</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
    </td>
