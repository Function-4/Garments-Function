...
<body>
    ...
    <ul>
        <li><a href="w_home.php">
                <center>Home</center>
            </a></li>
        <li><a href="w_appvac.php">
                <center>Apply For Vacation</center>
            </a></li>
        <li><a href="w_complain.php">
                <center>Apply For Complain</center>
            </a></li>
        <li><a href="w_reqover.php">
                <center>Request For Over-Time</center>
            </a></li>
        <li><a href="w_apphel.php">
                <center>Apply For Health Check-up</center>
            </a></li>
        <li>
