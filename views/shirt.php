...
<center><p4>Shirt Product</p4></center>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>shirt1</b></h4></center>
    ...
    <td> 
        ...
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shirt0</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
        </a>        
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shirt2</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shirt3</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shirt4</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center><h4><b>Shirt5</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
    </td>
