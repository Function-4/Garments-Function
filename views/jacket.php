...
<center><p4>Jacket Product</p4></center>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Jackets6</b></h4></center>
    ...
    <td> 
        ...
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Jackets4</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
        </a>        
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Jackets5</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Jackets0</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Jackets1</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center><h4><b>Jackets2</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
    </td>
