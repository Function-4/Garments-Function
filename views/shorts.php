...
<center><p4>Shorts Product</p4></center>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shorts5</b></h4></center>
    ...
    <td> 
        ...
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shorts4</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
        </a>        
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shorts3</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
...
<a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shorts2</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center> <h4><b>Shorts1</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
</a>
    ...
    <a href="b_order.php">
        <div class="card" >
            <img src="../assets/1.jpg" alt="peojuct" style="width:100%">
                <div class="container">
                   <center><h4><b>Shorts0</b></h4></center>
                   <center><p>Order Now</p> </center>
                </div>
        </div>
    </td>
